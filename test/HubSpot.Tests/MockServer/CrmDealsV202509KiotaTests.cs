...
public class CrmDealsV202509KiotaTests : IAsyncLifetime
{
    ...
    {
        var result = await _client.Crm.Objects.TwoZeroTwoFiveZeroNine["deals"].PostAsync(
    ...
    {
        var created = await _client.Crm.Objects.TwoZeroTwoFiveZeroNine["deals"].PostAsync(
            new SimplePublicObjectInputForCreate
            {
                Properties = new SimplePublicObjectInputForCreate_properties
                {
        ...
        var retrieved = await _client.Crm.Objects.TwoZeroTwoFiveZeroNine["deals"][id].GetAsync();
    ...
    public async Task Can_update_deal()
    {
        ...
        var updated = await _client.Crm.Objects.TwoZeroTwoFiveZeroNine["deals"][id].PatchAsync(
    ...
    public async Task Can_list_deals()
    {
        for (int i = 0; i < 3; i++)
        {
            await _client.Crm.Objects.TwoZeroTwoFiveZeroNine["deals"].PostAsync(
                new SimplePublicObjectInputForCreate
                {
                    Properties = new SimplePublicObjectInputForCreate_properties
                    {
        ...
        var response = await _client.Crm.Objects.TwoZeroTwoFiveZeroNine["deals"].GetAsync(
    ...
    {
        var response = await _client.Crm.Objects.TwoZeroTwoFiveZeroNine["deals"].Batch.Create.PostAsync(
