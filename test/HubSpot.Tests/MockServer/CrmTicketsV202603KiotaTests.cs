using DamianH.HubSpot.KiotaClient.CRM.Tickets.V202603;
using DamianH.HubSpot.KiotaClient.CRM.Tickets.V202603.Models;
using Microsoft.Kiota.Abstractions.Authentication;
using Microsoft.Kiota.Http.HttpClientLibrary;

namespace DamianH.HubSpot.MockServer;

public class CrmTicketsV202603KiotaTests : IAsyncLifetime
{
    private readonly ITestOutputHelper _outputHelper = TestContext.Current.TestOutputHelper!;
    private HubSpotMockServer _server = null!;
    private HubSpotCRMTicketsV202603Client _client = null!;
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        _client = new HubSpotCRMTicketsV202603Client(requestAdapter);
    }
    ...
    {
        var result = await _client.Crm.Objects.TwoZeroTwoSixZeroThree.Tickets.PostAsync(
    ...
    {
        var created = await _client.Crm.Objects.TwoZeroTwoSixZeroThree.Tickets.PostAsync(
            new SimplePublicObjectInputForCreate
            {
                Properties = new SimplePublicObjectInputForCreate_properties
                {
        ...
        var retrieved = await _client.Crm.Objects.TwoZeroTwoSixZeroThree.Tickets[id].GetAsync();
    ...
    public async Task Can_update_ticket()
    {
        ...
        var updated = await _client.Crm.Objects.TwoZeroTwoSixZeroThree.Tickets[id].PatchAsync(
    ...
    public async Task Can_list_tickets()
    {
        for (int i = 0; i < 3; i++)
        {
            await _client.Crm.Objects.TwoZeroTwoSixZeroThree.Tickets.PostAsync(
                new SimplePublicObjectInputForCreate
                {
                    Properties = new SimplePublicObjectInputForCreate_properties
                    {
        ...
        var response = await _client.Crm.Objects.TwoZeroTwoSixZeroThree.Tickets.GetAsync(
    ...
    {
        var response = await _client.Crm.Objects.TwoZeroTwoSixZeroThree.Tickets.Batch.Create.PostAsync(
