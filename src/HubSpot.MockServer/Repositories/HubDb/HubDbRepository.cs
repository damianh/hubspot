...
internal class HubDbRepository
{
    ...
    public HubDbTable CreateTable(HubDbTable table)
    {
        ...
        table.CreatedAt = _timeProvider.GetUtcNow().UtcDateTime;
        table.UpdatedAt = _timeProvider.GetUtcNow().UtcDateTime;
    ...
    public HubDbTable? UpdateTable(string id, HubDbTable updatedTable)
    {
        ...
        updatedTable.Id = id;
        updatedTable.UpdatedAt = _timeProvider.GetUtcNow().UtcDateTime;
    ...
    public HubDbRow CreateRow(string tableId, HubDbRow row)
    {
        ...
        row.CreatedAt = _timeProvider.GetUtcNow().UtcDateTime;
