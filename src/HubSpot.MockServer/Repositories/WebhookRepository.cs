...
public class WebhookRepository
{
    ...
    private static SubscriptionResponse_eventType MapEventType(string eventTypeString)
    {
    ...
    public bool ClearSettings(string appId)
    {
        return _settings.TryRemove(appId, out _);
    }
}
