...
internal class UrlRedirectRepository
{
    ...
    public UrlRedirect Create(UrlRedirect redirect)
    {
        ...
        redirect.Created = _timeProvider.GetUtcNow().UtcDateTime;
        redirect.Updated = _timeProvider.GetUtcNow().UtcDateTime;
    ...
    public UrlRedirect? Update(string id, UrlRedirect updatedRedirect)
    {
        ...
        updatedRedirect.Updated = _timeProvider.GetUtcNow().UtcDateTime;
