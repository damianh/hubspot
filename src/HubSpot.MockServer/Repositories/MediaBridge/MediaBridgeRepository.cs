...
internal class MediaBridgeRepository
{
    ...
    public MediaAsset Create(MediaAsset asset)
    {
        ...
        asset.CreatedAt = _timeProvider.GetUtcNow().UtcDateTime;
        asset.UpdatedAt = _timeProvider.GetUtcNow().UtcDateTime;
    ...
    public MediaAsset? Update(string id, MediaAsset updatedAsset)
    {
        ...
        updatedAsset.Id = id;
        updatedAsset.UpdatedAt = _timeProvider.GetUtcNow().UtcDateTime;
