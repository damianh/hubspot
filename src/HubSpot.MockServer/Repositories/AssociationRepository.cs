...
public class AssociationRepository
{
    ...
    public Dictionary<string, IReadOnlyList<Association>> GetAssociationsBatch(
        ...
        string toObjectType)
    {
        return fromObjectIds.ToDictionary(
            id => id,
    ...
    /// </summary>
    public AssociationTypeDefinition? GetAssociationType(string associationTypeId)
    {
        return _standardTypes.TryGetValue(associationTypeId, out var type)
            ? type
            : _customTypes.TryGetValue(associationTypeId, out var customType)
                ? customType
                : null;
    }
    ...
    private static string GetKey(
        ...
        string associationTypeId)
    {
        return $"{fromObjectType}:{fromObjectId}:{toObjectType}:{toObjectId}:{associationTypeId}";
    }
}
