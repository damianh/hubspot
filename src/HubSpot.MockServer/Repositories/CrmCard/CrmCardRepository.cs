...
namespace DamianH.HubSpot.MockServer.Repositories.CrmCard;
...
internal class CrmCardRepository
{
    ...
    private JsonElement CreateCardObject(string cardId, string appId, JsonElement body)
    {
    ...
    private JsonElement MergeCard(JsonElement existing, JsonElement updates)
    {
