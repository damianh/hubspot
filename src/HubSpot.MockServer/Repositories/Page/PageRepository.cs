...
internal class PageRepository
{
    ...
    public Page Create(Page page)
    {
        ...
        page.Created = _timeProvider.GetUtcNow().UtcDateTime;
        page.Updated = _timeProvider.GetUtcNow().UtcDateTime;
        _pages[page.Id] = page;
    ...
    public Page? Update(string id, Page updatedPage)
    {
        ...
        updatedPage.Id = id;
        updatedPage.Updated = _timeProvider.GetUtcNow().UtcDateTime;
