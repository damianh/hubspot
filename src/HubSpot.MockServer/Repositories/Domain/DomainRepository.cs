...
internal class DomainRepository
{
    ...
    public Domain Create(Domain domain)
    {
        ...
        domain.Created = _timeProvider.GetUtcNow().UtcDateTime;
        domain.Updated = _timeProvider.GetUtcNow().UtcDateTime;
    ...
    public Domain? Update(string id, Domain updatedDomain)
    {
        ...
        updatedDomain.Id = id;
        updatedDomain.Updated = _timeProvider.GetUtcNow().UtcDateTime;
