...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalValidatedFormField>? FormFields { get; set; }
#nullable restore
#else
        public List<global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalValidatedFormField> FormFields { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalLegalConsentResponse>? LegalConsentResponses { get; set; }
#nullable restore
#else
        public List<global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalLegalConsentResponse> LegalConsentResponses { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalMeetingBookingResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalMeetingBookingResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalMeetingBookingResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "formFields", n => { FormFields = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalValidatedFormField>(global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalValidatedFormField.CreateFromDiscriminatorValue)?.AsList(); } },
                { "guestEmails", n => { GuestEmails = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "isOffline", n => { IsOffline = n.GetBoolValue(); } },
                { "legalConsentResponses", n => { LegalConsentResponses = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalLegalConsentResponse>(global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalLegalConsentResponse.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalValidatedFormField>("formFields", FormFields);
            writer.WriteCollectionOfPrimitiveValues<string>("guestEmails", GuestEmails);
            writer.WriteBoolValue("isOffline", IsOffline);
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.Scheduler.Meetings.V202603.Models.ExternalLegalConsentResponse>("legalConsentResponses", LegalConsentResponses);
