...
namespace DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_access? Access { get; set; }
        ...
        public global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_duplicateValidationScope? DuplicateValidationScope { get; set; }
        ...
        public global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_duplicateValidationStrategy? DuplicateValidationStrategy { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "access", n => { Access = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_access>(); } },
                { "duplicateValidationScope", n => { DuplicateValidationScope = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_duplicateValidationScope>(); } },
                { "duplicateValidationStrategy", n => { DuplicateValidationStrategy = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_duplicateValidationStrategy>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_access>("access", Access);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_duplicateValidationScope>("duplicateValidationScope", DuplicateValidationScope);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.Files.Files.V202603.Models.ImportFromUrlInput_duplicateValidationStrategy>("duplicateValidationStrategy", DuplicateValidationStrategy);
