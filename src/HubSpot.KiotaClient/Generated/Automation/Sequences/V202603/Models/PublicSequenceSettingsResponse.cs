...
namespace DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse_eligibleFollowUpDays? EligibleFollowUpDays { get; set; }
...
#nullable restore
        ...
        public global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse_sellingStrategy? SellingStrategy { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "eligibleFollowUpDays", n => { EligibleFollowUpDays = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse_eligibleFollowUpDays>(); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "individualTaskRemindersEnabled", n => { IndividualTaskRemindersEnabled = n.GetBoolValue(); } },
                { "sellingStrategy", n => { SellingStrategy = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse_sellingStrategy>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse_eligibleFollowUpDays>("eligibleFollowUpDays", EligibleFollowUpDays);
            writer.WriteStringValue("id", Id);
            writer.WriteBoolValue("individualTaskRemindersEnabled", IndividualTaskRemindersEnabled);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.Automation.Sequences.V202603.Models.PublicSequenceSettingsResponse_sellingStrategy>("sellingStrategy", SellingStrategy);
