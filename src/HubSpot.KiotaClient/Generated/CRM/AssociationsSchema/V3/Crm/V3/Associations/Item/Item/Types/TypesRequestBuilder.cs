...
using DamianH.HubSpot.KiotaClient.CRM.AssociationsSchema.V3.Models;
...
using System;
namespace DamianH.HubSpot.KiotaClient.CRM.AssociationsSchema.V3.Crm.V3.Associations.Item.Item.Types
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CRM.AssociationsSchema.V3.Crm.V3.Associations.Item.Item.Types.TypesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::DamianH.HubSpot.KiotaClient.CRM.AssociationsSchema.V3.Models.CollectionResponsePublicAssociationDefinitionNoPaging?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::DamianH.HubSpot.KiotaClient.CRM.AssociationsSchema.V3.Models.CollectionResponsePublicAssociationDefinitionNoPaging> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CRM.AssociationsSchema.V3.Crm.V3.Associations.Item.Item.Types.TypesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::DamianH.HubSpot.KiotaClient.CRM.AssociationsSchema.V3.Crm.V3.Associations.Item.Item.Types.TypesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::DamianH.HubSpot.KiotaClient.CRM.AssociationsSchema.V3.Crm.V3.Associations.Item.Item.Types.TypesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
