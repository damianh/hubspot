...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.SimplePublicObjectId>? Inputs { get; set; }
#nullable restore
#else
        public List<global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.SimplePublicObjectId> Inputs { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.BatchReadInputSimplePublicObjectId"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.BatchReadInputSimplePublicObjectId"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.BatchReadInputSimplePublicObjectId CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.BatchReadInputSimplePublicObjectId();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "inputs", n => { Inputs = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.SimplePublicObjectId>(global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.SimplePublicObjectId.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CRM.Contacts.V3.Models.SimplePublicObjectId>("inputs", Inputs);
