...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::DamianH.HubSpot.KiotaClient.CRM.Pipelines.V3.Models.PipelineStage>? Stages { get; set; }
#nullable restore
#else
        public List<global::DamianH.HubSpot.KiotaClient.CRM.Pipelines.V3.Models.PipelineStage> Stages { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Pipelines.V3.Models.Pipeline"/> and sets the default values.
        /// </summary>
        public Pipeline()
        {
        ...
        public static global::DamianH.HubSpot.KiotaClient.CRM.Pipelines.V3.Models.Pipeline CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.CRM.Pipelines.V3.Models.Pipeline();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "stages", n => { Stages = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CRM.Pipelines.V3.Models.PipelineStage>(global::DamianH.HubSpot.KiotaClient.CRM.Pipelines.V3.Models.PipelineStage.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CRM.Pipelines.V3.Models.PipelineStage>("stages", Stages);
