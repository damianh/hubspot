...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter"/> and sets the default values.
        /// </summary>
        public PublicFormSubmissionOnPageFilter()
        {
            AdditionalData = new Dictionary<string, object>();
            FilterType = global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter_filterType.FORM_SUBMISSION_ON_PAGE;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "coalescingRefineBy", n => { CoalescingRefineBy = n.GetObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_coalescingRefineBy>(global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_coalescingRefineBy.CreateFromDiscriminatorValue); } },
                { "filterType", n => { FilterType = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter_filterType>(); } },
                { "formId", n => { FormId = n.GetStringValue(); } },
                { "operator", n => { Operator = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter_operator>(); } },
                { "pageId", n => { PageId = n.GetStringValue(); } },
                { "pruningRefineBy", n => { PruningRefineBy = n.GetObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_pruningRefineBy>(global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_pruningRefineBy.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_coalescingRefineBy>("coalescingRefineBy", CoalescingRefineBy);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter_filterType>("filterType", FilterType);
            writer.WriteStringValue("formId", FormId);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter_operator>("operator", Operator);
            writer.WriteStringValue("pageId", PageId);
            writer.WriteObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_pruningRefineBy>("pruningRefineBy", PruningRefineBy);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_coalescingRefineBy"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_coalescingRefineBy CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_coalescingRefineBy();
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_pruningRefineBy"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_pruningRefineBy CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicFormSubmissionOnPageFilter.PublicFormSubmissionOnPageFilter_pruningRefineBy();
                if("PublicAbsoluteComparativeTimestampRefineBy".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.PublicAbsoluteComparativeTimestampRefineBy = new global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicAbsoluteComparativeTimestampRefineBy();
                }
