...
#nullable enable
        public global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_coalescingRefineBy? CoalescingRefineBy { get; set; }
#nullable restore
#else
        public global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_coalescingRefineBy CoalescingRefineBy { get; set; }
#endif
...
#nullable restore
        ...
        public global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter_filterType? FilterType { get; set; }
        /// <summary>The pruningRefineBy property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_pruningRefineBy? PruningRefineBy { get; set; }
#nullable restore
#else
        public global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_pruningRefineBy PruningRefineBy { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter"/> and sets the default values.
        /// </summary>
        public PublicUnifiedEventsFilter()
        {
            AdditionalData = new Dictionary<string, object>();
            FilterType = global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter_filterType.UNIFIED_EVENTS;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "coalescingRefineBy", n => { CoalescingRefineBy = n.GetObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_coalescingRefineBy>(global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_coalescingRefineBy.CreateFromDiscriminatorValue); } },
                { "eventTypeId", n => { EventTypeId = n.GetStringValue(); } },
                { "filterLines", n => { FilterLines = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicEventFilterMetadata>(global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicEventFilterMetadata.CreateFromDiscriminatorValue)?.AsList(); } },
                { "filterType", n => { FilterType = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter_filterType>(); } },
                { "pruningRefineBy", n => { PruningRefineBy = n.GetObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_pruningRefineBy>(global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_pruningRefineBy.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_coalescingRefineBy>("coalescingRefineBy", CoalescingRefineBy);
            writer.WriteStringValue("eventTypeId", EventTypeId);
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicEventFilterMetadata>("filterLines", FilterLines);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter_filterType>("filterType", FilterType);
            writer.WriteObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_pruningRefineBy>("pruningRefineBy", PruningRefineBy);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_coalescingRefineBy"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_coalescingRefineBy CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_coalescingRefineBy();
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_pruningRefineBy"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_pruningRefineBy CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicUnifiedEventsFilter.PublicUnifiedEventsFilter_pruningRefineBy();
                if("PublicAbsoluteComparativeTimestampRefineBy".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.PublicAbsoluteComparativeTimestampRefineBy = new global::DamianH.HubSpot.KiotaClient.CRM.Lists.V3.Models.PublicAbsoluteComparativeTimestampRefineBy();
                }
