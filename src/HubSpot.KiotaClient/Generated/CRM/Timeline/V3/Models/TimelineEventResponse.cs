...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_extraData? ExtraData { get; set; }
#nullable restore
#else
        public global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_extraData ExtraData { get; set; }
#endif
        /// <summary>Identifier for the event. This should be unique to the app and event template. If you use the same ID for different CRM objects, the last to be processed will win and the first will not have a record. You can also use `{{uuid}}` anywhere in the ID to generate a unique string, guaranteeing uniqueness.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string ObjectId { get; set; }
#endif
        /// <summary>The ObjectType associated with the EventTemplate.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_tokens? Tokens { get; set; }
#nullable restore
#else
        public global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_tokens Tokens { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "extraData", n => { ExtraData = n.GetObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_extraData>(global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_extraData.CreateFromDiscriminatorValue); } },
                ...
                { "tokens", n => { Tokens = n.GetObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_tokens>(global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_tokens.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_extraData>("extraData", ExtraData);
            ...
            writer.WriteObjectValue<global::DamianH.HubSpot.KiotaClient.CRM.Timeline.V3.Models.TimelineEventResponse_tokens>("tokens", Tokens);
