...
#nullable restore
        ...
        public static global::DamianH.HubSpot.KiotaClient.Settings.Multicurrency.V3.Models.ExchangeRate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.Settings.Multicurrency.V3.Models.ExchangeRate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fromCurrencyCode", n => { FromCurrencyCode = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.Settings.Multicurrency.V3.Models.ExchangeRate_fromCurrencyCode>(); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "toCurrencyCode", n => { ToCurrencyCode = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.Settings.Multicurrency.V3.Models.ExchangeRate_toCurrencyCode>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.Settings.Multicurrency.V3.Models.ExchangeRate_fromCurrencyCode>("fromCurrencyCode", FromCurrencyCode);
            writer.WriteStringValue("id", Id);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.Settings.Multicurrency.V3.Models.ExchangeRate_toCurrencyCode>("toCurrencyCode", ToCurrencyCode);
