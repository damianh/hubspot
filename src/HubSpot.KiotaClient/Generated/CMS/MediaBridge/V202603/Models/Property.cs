...
#nullable enable
        public List<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.ObjectTypeIdProto>? AllowedObjectTypes { get; set; }
#nullable restore
#else
        public List<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.ObjectTypeIdProto> AllowedObjectTypes { get; set; }
#endif
...
#nullable restore
        ...
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_dataSensitivity? DataSensitivity { get; set; }
        /// <summary>The dateDisplayHint property</summary>
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_dateDisplayHint? DateDisplayHint { get; set; }
...
#nullable restore
        ...
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_displayMode? DisplayMode { get; set; }
...
#nullable restore
        ...
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_numberDisplayHint? NumberDisplayHint { get; set; }
        /// <summary>A list of valid options for the property. This field is required for enumerated properties.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Option>? Options { get; set; }
#nullable restore
#else
        public List<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Option> Options { get; set; }
#endif
        ...
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_optionSortStrategy? OptionSortStrategy { get; set; }
        ...
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_referencedObjectType? ReferencedObjectType { get; set; }
        ...
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_searchTextAnalysisMode? SearchTextAnalysisMode { get; set; }
...
#nullable restore
        ...
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_textDisplayHint? TextDisplayHint { get; set; }
        /// <summary>The data type of the property, such as string or number.</summary>
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_type? Type { get; set; }
        /// <summary>The timestamp when the property was last updated, in ISO 8601 format.</summary>
        public long? UpdatedAt { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property"/> and sets the default values.
        /// </summary>
        public Property()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedObjectTypes", n => { AllowedObjectTypes = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.ObjectTypeIdProto>(global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.ObjectTypeIdProto.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "dataSensitivity", n => { DataSensitivity = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_dataSensitivity>(); } },
                { "dateDisplayHint", n => { DateDisplayHint = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_dateDisplayHint>(); } },
                { "deleted", n => { Deleted = n.GetBoolValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "displayMode", n => { DisplayMode = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_displayMode>(); } },
                ...
                { "numberDisplayHint", n => { NumberDisplayHint = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_numberDisplayHint>(); } },
                { "optionSortStrategy", n => { OptionSortStrategy = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_optionSortStrategy>(); } },
                { "options", n => { Options = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Option>(global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Option.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "referencedObjectType", n => { ReferencedObjectType = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_referencedObjectType>(); } },
                { "searchTextAnalysisMode", n => { SearchTextAnalysisMode = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_searchTextAnalysisMode>(); } },
                ...
                { "textDisplayHint", n => { TextDisplayHint = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_textDisplayHint>(); } },
                { "type", n => { Type = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.ObjectTypeIdProto>("allowedObjectTypes", AllowedObjectTypes);
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_dataSensitivity>("dataSensitivity", DataSensitivity);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_dateDisplayHint>("dateDisplayHint", DateDisplayHint);
            writer.WriteBoolValue("deleted", Deleted);
            writer.WriteStringValue("description", Description);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_displayMode>("displayMode", DisplayMode);
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_numberDisplayHint>("numberDisplayHint", NumberDisplayHint);
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Option>("options", Options);
            writer.WriteBoolValue("optionsAreMutable", OptionsAreMutable);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_optionSortStrategy>("optionSortStrategy", OptionSortStrategy);
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_referencedObjectType>("referencedObjectType", ReferencedObjectType);
            writer.WriteBoolValue("searchableInGlobalSearch", SearchableInGlobalSearch);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_searchTextAnalysisMode>("searchTextAnalysisMode", SearchTextAnalysisMode);
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_textDisplayHint>("textDisplayHint", TextDisplayHint);
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V202603.Models.Property_type>("type", Type);
