...
#nullable enable
        public List<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.AssociationSpec>? AssociationTypes { get; set; }
#nullable restore
#else
        public List<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.AssociationSpec> AssociationTypes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression.RollupExpression_conditionalExpression? ConditionalExpression { get; set; }
#nullable restore
#else
        public global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression.RollupExpression_conditionalExpression ConditionalExpression { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "associationTypes", n => { AssociationTypes = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.AssociationSpec>(global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.AssociationSpec.CreateFromDiscriminatorValue)?.AsList(); } },
                { "conditionalExpression", n => { ConditionalExpression = n.GetObjectValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression.RollupExpression_conditionalExpression>(global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression.RollupExpression_conditionalExpression.CreateFromDiscriminatorValue); } },
                { "conditionalFormula", n => { ConditionalFormula = n.GetStringValue(); } },
                { "emptyRollupValue", n => { EmptyRollupValue = n.GetStringValue(); } },
                { "rollupOperator", n => { RollupOperator = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.AssociationSpec>("associationTypes", AssociationTypes);
            writer.WriteObjectValue<global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression.RollupExpression_conditionalExpression>("conditionalExpression", ConditionalExpression);
            writer.WriteStringValue("conditionalFormula", ConditionalFormula);
            writer.WriteStringValue("emptyRollupValue", EmptyRollupValue);
            writer.WriteStringValue("rollupOperator", RollupOperator);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression.RollupExpression_conditionalExpression"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression.RollupExpression_conditionalExpression CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::DamianH.HubSpot.KiotaClient.CMS.MediaBridge.V1.Models.RollupExpression.RollupExpression_conditionalExpression();
