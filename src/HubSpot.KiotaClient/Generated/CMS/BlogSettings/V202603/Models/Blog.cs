...
#nullable restore
        ...
        public global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.Blog_language? Language { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.PublicAccessRule>? PublicAccessRules { get; set; }
#nullable restore
#else
        public List<global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.PublicAccessRule> PublicAccessRules { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.Blog"/> and sets the default values.
        /// </summary>
        public Blog()
        {
        ...
        public static global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.Blog CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.Blog();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "language", n => { Language = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.Blog_language>(); } },
                { "listingPageId", n => { ListingPageId = n.GetStringValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "publicAccessRules", n => { PublicAccessRules = n.GetCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.PublicAccessRule>(global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.PublicAccessRule.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.Blog_language>("language", Language);
            writer.WriteStringValue("listingPageId", ListingPageId);
            writer.WriteStringValue("name", Name);
            writer.WriteCollectionOfObjectValues<global::DamianH.HubSpot.KiotaClient.CMS.BlogSettings.V202603.Models.PublicAccessRule>("publicAccessRules", PublicAccessRules);
