...
#nullable restore
        ...
        public global::DamianH.HubSpot.KiotaClient.Marketing.TransactionalSingleSend.V3.Models.EmailSendStatusView_sendResult? SendResult { get; set; }
        /// <summary>Time when the send began processing.</summary>
        public DateTimeOffset? StartedAt { get; set; }
        /// <summary>Status of the send request.</summary>
        public global::DamianH.HubSpot.KiotaClient.Marketing.TransactionalSingleSend.V3.Models.EmailSendStatusView_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DamianH.HubSpot.KiotaClient.Marketing.TransactionalSingleSend.V3.Models.EmailSendStatusView"/> and sets the default values.
        /// </summary>
        ...
        public static global::DamianH.HubSpot.KiotaClient.Marketing.TransactionalSingleSend.V3.Models.EmailSendStatusView CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::DamianH.HubSpot.KiotaClient.Marketing.TransactionalSingleSend.V3.Models.EmailSendStatusView();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::DamianH.HubSpot.KiotaClient.Marketing.TransactionalSingleSend.V3.Models.EmailSendStatusView_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::DamianH.HubSpot.KiotaClient.Marketing.TransactionalSingleSend.V3.Models.EmailSendStatusView_status>("status", Status);
